...
################## INSTALLATION ######################
RUN apt-get update && apt-get install -y git lftp libarchive-dev wget

# Installing Mamba
RUN conda install -c conda-forge mamba

# Python Package Installations
RUN mamba install -c conda-forge -y datashader=0.12.1
RUN mamba install -c conda-forge -y openjdk=11.0.9.1
