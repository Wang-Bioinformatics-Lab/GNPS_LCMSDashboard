...
EXAMPLE_DASHBOARD = [
    ...
    dbc.CardBody(
        [
            ...
            html.Br(),
            html.A("GCMS in CDF Format", href="/?usi=mzspec:MSV000084169:raw/FractA1/0205045.CDF"),
            html.Br(),
            html.Br(),
